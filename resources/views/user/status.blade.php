...
<body style="background-color: whitesmoke;">
  ...
  <main id="main">
    ...
    <section style="padding-top: 150px; padding-bottom: 90px;">
        <div class="container">
          <div class="row justify-content-center" style="padding: 70px; padding-top:0px">
            <div class="col-xl-6 col-lg-8">
                <h1 style="text-align: center; font-weight:bold; font-size:50px">Visualisez le statut de votre demande</h1>
            </div>
          </div>
            <div class="row">
