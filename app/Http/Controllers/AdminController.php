...
class AdminController extends Controller
{
    ...
    public function bord(){
        ...
        $totalAttente=demande::all()->where('status','En attente')->count();
        $totalRejet=demande::all()->where('status','Rejetée')->count();
        $totalTraite=demande::all()->where('status','Traitée')->count();
        $totalEncours=demande::all()->where('status','En cours de traitement')->count();
        return view('admin.bord',compact('data','totalRejet','totalAttente','totalEncours','totalTraite'));
